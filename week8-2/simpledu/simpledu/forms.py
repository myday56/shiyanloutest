...
from wtforms.validators import Length,Regexp, Email, EqualTo, Required
from simpledu.models import db, User
from wtforms import ValidationError
import re

class RegisterForm(FlaskForm):
    username = StringField('Username', validators=[Required(), Length(3, 24),Regexp("^[a-zA-Z0-9]*$")])
    ...
    def validate_username(self, field):
        if not re.search(u'^[a-zA-Z0-9]*$',self.username.data):
