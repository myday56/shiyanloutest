...
class IncomeTaxCalculator:
    def calc_for_all_userdata(self,q2,q1):
        ...
        userdata_after_calc = []
        userdata_list = UserData().read_user_data(q1)
...
def main():
    Process(target=UserData().read_user_data, args=(queue1,)).start()
